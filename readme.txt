...
* New: Support to WooCommerce 3.3.0 version.
* New: Hooks for third parties.
* Tweak: Code format to WordPress standard.
* Tweak: Now you can define cart text on expired events.
* Update: Plugin core.
* Fix: Date picker issue.

= 1.1.5 =

* Tweak: Added new filters for third parties.
* Tweak: Date resumed on Event product page.
* Fix: Issue with Barcodes.
...
* Fix: Some issues and style problems.

= 1.1.4 =

* New: Option to make events expire after the end date.
* Fix: Auto generation tickets when order status changed.
* Fix: Minor issues.
...
* New: Renew admin tickets table style. Added shortable columns.
* New: Added hooks for third developers.
* New: Added Yes/No option field.
* Tweak: Added option to hide label and put placeholder on fields.
* Tweak: Added option that allow print ticket number just before title on email template.
* Tweak: PDF ticket change background color to white to optimize ink printer.
...
* New: Added date picker for field date on frontend.
* Fix: NAN price.
